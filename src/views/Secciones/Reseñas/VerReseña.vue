...
export default {
    ...
    created: function () { this.cargarResenas() },
    methods: {
        cargarResenas(){
...
<template>
            ...
            <div class="input-group my-3 w-75 mx-auto">
                        <input type="text" class="form-control" v-model="param" placeholder="Busca una reseña">
        ...
        <div class="container">
            <div v-for="resena in resenas" :key="resena.id">
                <div class="card-sl">
                    ...
                    <div class="card-text">
                        Redactada por: {{resena.id_usuario}}
                    </div>
                    <RouterLink :to="{name: 'reseñaarticulo', params: {id: resena.id}}" class="card-button">Revisar reseña</RouterLink>
                </div>
            </div>
        </div>
