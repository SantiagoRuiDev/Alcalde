...
<template>
  <div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox-content m-b-sm border-bottom">
      <div class="p-xs text-center">
        <div class="pull-left m-r-md">
          <i class="fa fa-microphone text-navy mid-icon"></i>
        </div>
        <h2 class="mt-5">Comunicados</h2>
      </div>
      ...
      <div class="d-grid gap-2">
        ...
        >
          ...
          <div>
            ...
            <small>Autor: {{ comunicado.nombre }}, Fecha de escritura: {{ comunicado.fecha }}</small>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="ibox-content forum-container" id="forumContainer">
      <div class="inicio-content">
        ...
        <div class="card text-center shadow col">
          <div class="card-body">
            <span class="material-symbols-outlined fs-1 mb-3"> mail </span>
        ...
        <div class="card text-center shadow col">
          <div class="card-body rounded">
            <span class="material-symbols-outlined fs-1 mb-3"> security </span>
